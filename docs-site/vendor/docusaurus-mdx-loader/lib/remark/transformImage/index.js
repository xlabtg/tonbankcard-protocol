...
async function toImageRequireNode([node], imagePath, context) {
    ...
    // CHECK423-M2 / #429: intentionally do not inspect image bytes here.
    // The upstream image-size parser has High-severity infinite-loop
    // advisories. Webpack still verifies and emits the referenced asset, but
    // dimensions must be supplied explicitly by reviewed documentation.
