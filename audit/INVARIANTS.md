...
| Contract | Location | What to Verify |
|----------|----------|----------------|
| `PaymentHub.tact` | No account initializer | The test-only `InitializeAccount` handler was removed from production (Issue #427); admin cannot seed arbitrary owner/balance state (I3/I5) |
...
| deployer | Deploy and administer non-fund parameters | Initialize accounts, mint balances, or move funds (`InitializeAccount` removed by Issue #427) |
