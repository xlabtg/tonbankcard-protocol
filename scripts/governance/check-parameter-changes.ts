...
const PARAMETER_INVENTORY: ParameterRecord[] = [
  ...
  {
    id: "PP-1",
    contract: "governance/ProposalRegistry.tact",
    parameter: "DEFAULT_VOTING_DURATION",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-2",
    contract: "governance/ProposalRegistry.tact",
    parameter: "DEFAULT_QUORUM_THRESHOLD",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-3",
    contract: "governance/ProposalRegistry.tact",
    parameter: "DIAMONDS_TOTAL_SUPPLY",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  {
    id: "PP-7",
    contract: "governance/SnapshotVerifier.tact",
    parameter: "proposal_registry",
    classification: "T",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-41",
    contract: "governance/SnapshotVerifier.tact",
    parameter: "trusted_indexer",
    classification: "G",
    recommendedQuorum: 44,
    recommendedCooldownHours: 48,
    proposalCategory: 1,
  }, // Issue #370 / PC-01 — deployer-only, rotatable; sole authorised RegisterSnapshot writer
  {
    id: "PP-8",
    contract: "governance/TransparencyRegistry.tact",
    parameter: "snapshot pointer",
    classification: "G",
    recommendedQuorum: 22,
    recommendedCooldownHours: 48,
    proposalCategory: 3,
  },
  {
    id: "PP-9",
    contract: "governance/TransparencyRegistry.tact",
    parameter: "quorum_threshold (init-only)",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  // §8.3 Payment contracts
  {
    ...
    classification: "T",
    recommendedQuorum: 0,
    recommendedCooldownHours: 7 * 24,
  },
  {
    id: "PP-12",
    contract: "payments/PaymentHub.tact",
    parameter: "ADMIN_TRANSFER_DELAY",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-13",
    contract: "payments/PaymentHub.tact",
    parameter: "whitelisted_collections",
    classification: "G",
    recommendedQuorum: 44,
    recommendedCooldownHours: 48,
    proposalCategory: 0,
  },
  {
    id: "PP-14",
    contract: "payments/PaymentHub.tact",
    parameter: "accounts (no admin init; Issue #427)",
    classification: "U",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-15",
    contract: "MerchantPaymentHub.tact",
    parameter: "admin",
    classification: "T",
    recommendedQuorum: 0,
    recommendedCooldownHours: 7 * 24,
  },
  {
    id: "PP-16",
    contract: "MerchantPaymentHub.tact",
    parameter: "MERCHANT_ADMIN_TRANSFER_DELAY",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  },
  {
    id: "PP-19",
    contract: "MerchantPaymentHub.tact",
    parameter: "account_balances (initial)",
    classification: "G",
    recommendedQuorum: 44,
    recommendedCooldownHours: 48,
    proposalCategory: 1,
  },
  {
    id: "PP-20",
    contract: "MerchantPaymentHub.tact",
    parameter: "account_locks",
    classification: "G",
    recommendedQuorum: 22,
    recommendedCooldownHours: 24,
    proposalCategory: 3,
  },
  ...
  {
    id: "PP-21",
    contract: "RecurringPayments.tact",
    parameter: "MIN_PERIOD_SECONDS",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  {
    id: "PP-23",
    contract: "MultiSigCard.tact",
    parameter: "multisig_configs",
    classification: "U",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  {
    id: "PP-25",
    contract: "CrossChainBridge.tact",
    parameter: "bridge_intents",
    classification: "U",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  ...
  {
    id: "PP-29",
    contract: "CollateralSignal.tact",
    parameter: "collateral_signals",
    classification: "U",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-30",
    contract: "LendingProtocolCoordinator.tact",
    parameter: "lending_intents",
    classification: "U",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-31",
    contract: "collateral-lookup/PublicCollateralLookup.tact",
    parameter: "owner",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
  {
    id: "PP-32",
    contract: "collateral-lookup/PublicCollateralLookup.tact",
    parameter: "accountLocksContract",
    classification: "G",
    recommendedQuorum: 22,
    recommendedCooldownHours: 48,
    proposalCategory: 1,
  ...
  {
    id: "PP-34",
    contract: "nft-resolver/nft_account_resolver.tact",
    parameter: "payment_hub",
    classification: "G",
    recommendedQuorum: 22,
    recommendedCooldownHours: 48,
    proposalCategory: 1,
  },
  {
    id: "PP-35",
    contract: "nft-resolver/nft_account_resolver.tact",
    parameter: "COLLECTION_7777/8888",
    classification: "I",
    recommendedQuorum: 0,
    recommendedCooldownHours: 0,
  },
...
function classify(parameterId: string): number {
  ...
  if (!record) {
    console.error(
      `error: parameter ${parameterId} is not in the inventory (docs/governance/PARAMETERS.md §8)`,
    );
    return 2;
  }
  const recommendedQuorum =
    record.recommendedQuorum > 0 ? record.recommendedQuorum : DEFAULT_QUORUM;
  const cooldown =
    record.recommendedCooldownHours > 0 ? record.recommendedCooldownHours : 0;
  console.log(
    JSON.stringify(
      {
        ...
        requires_governance_proposal:
          record.classification === "G" || record.classification === "T",
      },
      null,
      2,
    ),
...
function parseProposalMarkdown(text: string): Partial<ParameterChangeProposal> {
  ...
  const checks = Array.from(sectionEight.matchAll(/^- \[([ xX])\]/gm)).map(
    (m) => m[1].toLowerCase() === "x",
  );
...
function validateProposal(
  ...
  if (!record) {
    issues.push({
      level: "error",
      message: `Parameter ${proposal.parameterId} is not in the inventory (docs/governance/PARAMETERS.md §8). Update PARAMETERS.md before submitting.`,
    });
    return issues;
  }
  ...
  if (record.classification !== "G" && record.classification !== "T") {
    issues.push({
      level: "error",
      message: `Parameter ${proposal.parameterId} is classified ${record.classification}; parameter-change proposals only apply to G or T parameters. Use the redeployment template instead.`,
    });
  }
  ...
  if (proposal.votingWindowDays < MIN_VOTING_WINDOW_DAYS) {
    issues.push({
      level: "error",
      message: `Voting window ${proposal.votingWindowDays} days is below the 7-day floor (PARAMETERS.md §3, P-3).`,
    });
  }
  ...
  if (proposal.quorumThreshold < requiredQuorum) {
    issues.push({
      level: "error",
      message: `Quorum ${proposal.quorumThreshold} is below the recommended ${requiredQuorum} for ${proposal.parameterId} (PARAMETERS.md §9).`,
    });
  }

  const requiredCooldown =
    record.recommendedCooldownHours > 0
      ? record.recommendedCooldownHours
      : MIN_COOLDOWN_HOURS;
  const cooldownFloor =
    proposal.parameterId === "PP-20"
      ? MIN_EMERGENCY_COOLDOWN_HOURS
      : MIN_COOLDOWN_HOURS;
  if (proposal.cooldownHours < cooldownFloor) {
    issues.push({
      level: "error",
      message: `Cooldown ${proposal.cooldownHours} h is below the protocol floor (${cooldownFloor} h; PARAMETERS.md §5/§9).`,
    });
  }
  if (proposal.cooldownHours < requiredCooldown) {
    issues.push({
      level: "warning",
      message: `Cooldown ${proposal.cooldownHours} h is below the recommended ${requiredCooldown} h for ${proposal.parameterId} (PARAMETERS.md §9).`,
    });
  }

  if (
    record.proposalCategory !== undefined &&
    proposal.category !== record.proposalCategory
  ) {
    issues.push({
      level: "warning",
      message: `Category ${proposal.category} differs from the recommended category ${record.proposalCategory} for ${proposal.parameterId}.`,
    });
  }
  ...
  if (proposal.authorNftId < 1 || proposal.authorNftId > 222) {
    issues.push({
      level: "error",
      message: `Author NFT ID ${proposal.authorNftId} is out of range (must be 1..222).`,
    });
  }

  if (
    proposal.executorThresholdM < MIN_EXECUTOR_M ||
    proposal.executorThresholdN < MIN_EXECUTOR_N ||
    proposal.executorThresholdM > proposal.executorThresholdN
  ) {
    issues.push({
      level: "error",
      message: `Executor multi-sig threshold ${proposal.executorThresholdM}-of-${proposal.executorThresholdN} is below the 2-of-3 minimum (PARAMETERS.md §10).`,
    });
  }

  if (
    !proposal.executorMultisig ||
    !proposal.executorMultisig.startsWith("EQ")
  ) {
    issues.push({
      level: "error",
      message: `Executor multi-sig address must be a base64-url TON address starting with "EQ".`,
    });
  }

  if (
    !proposal.transparencyChecklist ||
    proposal.transparencyChecklist.length < 3 ||
    !proposal.transparencyChecklist.slice(0, 3).every(Boolean)
  ) {
    issues.push({
      level: "error",
      message: `All three checkboxes in §8 (TransparencyRegistry logging requirement) must be checked.`,
    });
  }
  ...
  if (strict && !proposal.metadataJson) {
    issues.push({
      level: "error",
      message: `Appendix A (canonical metadata JSON) is missing or unparseable. The on-chain metadata_hash anchors this JSON.`,
    });
  }
  ...
  if (proposal.metadataJson) {
    try {
      ...
      console.log(
        `computed metadata_hash (sha-256 of canonical JSON): ${hash}`,
      );
    } catch (e) {
      issues.push({
        level: "error",
        message: `Appendix A metadata JSON is invalid: ${(e as Error).message}`,
      });
    }
  }
...
function validateProposalFile(filename: string, strict: boolean): number {
  ...
  if (!parsed.parameterId) {
    console.error(
      `error: could not find a Parameter ID (PP-<n>) in ${filename}. Use the template in docs/governance/PARAMETER_CHANGES.md §2.`,
    );
    return 2;
  }
  ...
  if (errors.length === 0 && warnings.length === 0) {
    console.log(
      `ok: ${filename} — ${parsed.parameterId} (${parsed.executorThresholdM}-of-${parsed.executorThresholdN}, quorum ${parsed.quorumThreshold}, cooldown ${parsed.cooldownHours} h)`,
    );
  } else {
    console.log(
...
function auditManifest(filename: string): number {
  ...
  for (const c of manifest.contracts ?? []) {
    if (!c.admin) {
      console.error(
        `ERROR: ${c.name} (${c.address}) has no admin field; refusing to publish.`,
      );
      problems++;
      continue;
    }
    if (c.admin.kind === "eoa") {
      console.error(
        `ERROR: ${c.name} (${c.address}) admin is an EOA (${c.admin.address}); single-key parameter control is forbidden (PARAMETERS.md §10).`,
      );
      problems++;
      continue;
    }
    if (c.admin.kind === "multisig") {
      ...
      if (!t || t.m < MIN_EXECUTOR_M || t.n < MIN_EXECUTOR_N || t.m > t.n) {
        console.error(
          `ERROR: ${c.name} multi-sig threshold ${t?.m}-of-${t?.n} is below the 2-of-3 minimum (PARAMETERS.md §10).`,
        );
        problems++;
        continue;
      }
      if (!c.admin.signers || c.admin.signers.length !== t.n) {
        console.error(
          `ERROR: ${c.name} multi-sig signer list length does not match n=${t.n}.`,
        );
        problems++;
        continue;
      }
    ...
    console.log(
      `ok: ${c.name} — admin is ${c.admin.kind} ${c.admin.address}${c.admin.threshold ? ` (${c.admin.threshold.m}-of-${c.admin.threshold.n})` : ""}`,
    );
  }
  if (problems > 0) {
    console.log(
      `summary: ${problems} problem(s) — manifest must not be published.`,
    );
    return 2;
  }
  console.log(
    `summary: all admin fields satisfy the single-key elimination policy.`,
  );
  return 0;
}
...
function main(argv: string[]): number {
  ...
  if (args[0] === "--list") {
    for (const r of PARAMETER_INVENTORY) {
      console.log(
        `${r.id}\t${r.classification}\t${r.contract}\t${r.parameter}`,
      );
    }
    return 0;
  }
